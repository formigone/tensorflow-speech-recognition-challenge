...
def model_fn(features, labels, mode, params):
    ...
    x = tf.reshape(features, [-1, 99, 161, 1], name='input_deep_cnn3')
    ...
    # (99, 161, 1)
    conv1 = tf.layers.conv2d(x_norm, filters=64, kernel_size=3, activation=tf.nn.relu, name='conv1')
    # (97, 159, 64)
    ...
    # (16384)
    dense5 = tf.layers.dense(pool4_flat, units=2048, activation=tf.nn.relu, name='dense5')
    # (128)
    dense6 = tf.layers.dense(dense5, units=2048, activation=tf.nn.relu, name='dense6')
    # (64)
