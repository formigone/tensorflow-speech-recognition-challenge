...
def model_fn(features, labels, mode, params):
  x = tf.reshape(features, [-1, 99, 161, 1], name='input_incep10v2')
  ...
  incep4 = inception_block(pool3, t1x1=8, t3x3=8, t5x5=8, tmp=8, name='incep4')
  ...
  incep9 = inception_block(incep8, t1x1=64, t3x3=64, t5x5=64, tmp=64, name='incep9')
  incep10 = inception_block(incep9, t1x1=128, t3x3=128, t5x5=128, tmp=128, name='incep10')
  incep11 = inception_block(incep10, t1x1=128, t3x3=128, t5x5=128, tmp=128, name='incep11')
  incep12 = inception_block(incep11, t1x1=256, t3x3=256, t5x5=256, tmp=256, name='incep12')
  incep13 = inception_block(incep12, t1x1=512, t3x3=512, t5x5=512, tmp=512, name='incep13')
  incep14 = inception_block(incep13, t1x1=512, t3x3=512, t5x5=512, tmp=512, name='incep14')

  flat = flatten(incep14)
  dropout4 = tf.layers.dropout(flat, rate=params['dropout_rate'], training=mode == tf.estimator.ModeKeys.TRAIN,
                               name='dropout4')
